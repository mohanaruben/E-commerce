...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="index.php"><span style="color:red;font-family: 'Permanent Marker', cursive;">BUCKEEDO'S</span></a>
    <?php
	if(!empty($cust_id))
	{
	?>
...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="img/58e5e109-.jpg" alt="buckeedos img1" class="d-block w-100">
      <div class="carousel-caption">
        <h3>BUCKEEDOS</h3>
        <p>We proved to have oders with You</p>
      </div>   
    </div>
    <div class="carousel-item">
      <img src="img/a1747c51-5064-458c-912d-e9cca804aafb.jpg" alt="buckeedos img2" class="d-block w-100">
      <div class="carousel-caption">
        <h3>BUCKEEDOS</h3>
        <p>We proved to have oders with You</p>
      </div>   
    ...
    <div class="carousel-item">
      <img src="img\c1744567-1.jpg" alt="buckeedos img3" class="d-block w-100">
      <div class="carousel-caption">
        <h3>BUCKEEDOS</h3>
        <p>We proved to have oders with You</p>
      </div>   
...
<div class="column">
	...
	<?php
	  ...
	  <div class="container-fluid">
		 ...
		 <form method="post">
		 <!--<h5 class="text-info">Quantity: <input type="number" min="1" max="25" name="quantity" class="container-fluid" value="1" style="width: 60px;"> </h5>-->
...
<div class="container-fluid">
    <div class="column"><!--main row-->
          <div class="col-sm-7"><!--main row 2 left-->
	           <br>
	            <div class="container-fluid rounded" style="border:solid 1px #F0F0F0; align:left;"><!--product container-->
	                  <?php
	                        $food_id=$arr[1];
	                        $query=mysqli_query($con,"select tblvendor.fld_email,tblvendor.fld_name,tblvendor.fld_mob,
